...
encoded_input = tokenizer("translate English to German: How old are you?",
                          return_tensors="pt", padding=True, truncation=True)

#decoder_start = torch.tensor([[tokenizer.pad_token_id]])
...
ep = torch.export.export(
    ...
    dynamic_shapes={
        "input_ids": {0: 1, 1: 11},  # input_ids
        "attention_mask": {0: 1, 1: 11},                  # attention_mask (same dim)
